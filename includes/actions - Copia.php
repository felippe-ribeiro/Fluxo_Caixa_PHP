...
if (isset($_POST['acao']) && $_POST['acao'] == 'editar_mov') {
    ...
    mysql_query("UPDATE lc_movimento SET dia='$dia', tipo='$tipo', cat='$cat', descricao='$descricao', valor='$valor', responsavel='$responsavel' WHERE id='$id'");
    echo mysql_error();
...
if (isset($_POST['acao']) && $_POST['acao'] == 1) {
    ...
    mysql_query("INSERT INTO lc_movimento (dia,mes,ano,tipo,descricao,valor,cat) values ('$dia','$mes','$ano','$tipo','$descricao','$valor','$responsavel','$cat')");
